...
void LibraryList::on_AppedLib_clicked()
{
    ...
    // 槽函数
    connect(itemWidget,&LibListItem::update,this,[=](FT_SOCKET sockid){
        // 获取服务器上的备份库的记录
        int count = 1;
        while(1)
        {
            ...
            // itemWidget->setLibAddr(ui->NetAddr->text());

            // itemWidget->setLibPort(ui->NetPort->text());
